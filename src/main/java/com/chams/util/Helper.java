package com.chams.util;

import com.chams.contracts.IDatabase;
import com.chams.model.User;
import com.chams.repository.DiaryRepository;
import com.chams.repository.MySQL;
import com.chams.repository.UserRepository;
import java.io.File;
...
public class Helper {
    ...
    public static String DB_SOURCE = "jdbc:mysql://mysqldb-container:3306/jspDiary?useSSL=false&serverTimezone=UTC&user=root&password=root&charset=UTF-8";
